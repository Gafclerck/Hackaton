...
class Dossier(Base):
    ...
    # agence_assigne: Mapped["Agence"] = relationship("Agence", foreign_keys=[agence_assigne_id])
    # avocat_assigne: Mapped["User"] = relationship("User", foreign_keys=[avocat_assigne_id])
